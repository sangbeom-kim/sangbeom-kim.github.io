...
caption: #what displays in the portfolio grid:
  ...
  content: Two-player ladder-tile strategy game.
  thumbnail: assets/img/LadderChess.png
  
#what displays when the item is clicked:
title: Ladder Chess
subtitle: C++
video: https://github.com/sangbeom-kim/sangbeom-kim.github.io/releases/download/Video/LadderChess.mp4
alt: LadderChess
