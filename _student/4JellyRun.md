...
caption: #what displays in the portfolio grid:
  ...
  content: Auto-scrolling runner with music-synced obstacles.
  thumbnail: assets/img/JellyRun.png
  
#what displays when the item is clicked:
title: Jelly Run
subtitle: JavaScript (P5.js)
video: https://github.com/sangbeom-kim/sangbeom-kim.github.io/releases/download/Video/JellyRun.mp4
alt: JellyRun
